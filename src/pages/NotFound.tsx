...
export default function NotFound() {
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center px-5 pt-32 text-center bg-white">
      <p className="text-[clamp(5rem,18vw,8rem)] font-black leading-none text-blue">404</p>
